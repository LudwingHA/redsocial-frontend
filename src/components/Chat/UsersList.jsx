    ...
    <div className="divide-y divide-gray-100/50 dark:divide-gray-700/50">
      {users.map((user) => (
        <div
          ...
          className="p-4 cursor-pointer hover:bg-gradient-to-r from-blue-50/50 to-purple-50/50 dark:hover:from-blue-900/20 dark:hover:to-purple-900/20 transition-all duration-300 group"
        >
